...
export const loader: LoaderFunction = async ({ request }) => {
  ...
  const existingMetafieldRes = await admin.graphql(`
    query {
      appInstallation {
        metafields(first: 1, keys: [
          "product_reviews.reviews_8003700228148",
          "product_reviews.rating_8003700228148",
          "product_reviews.count_8003700228148"
        ]) {
          edges {
            node {
              id
  ...
  console.log("response đây : ", responseJson);
  return null;
  // return { firstBlock };
};
