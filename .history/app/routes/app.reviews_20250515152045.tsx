...
export const loader: LoaderFunction = async ({ request }) => {
  ...
  // Đoạn code GraphQL query có thể được bổ sung sau
  const productId = "8003700228148";

  const response = await admin.graphql(`
    query {
      appInstallation {
        metafields(first: 2, keys: [
  ...
  console.log("responseJson", responseJson.data.appInstallation.metafields);
