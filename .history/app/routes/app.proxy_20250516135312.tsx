...
export const action: ActionFunction = async ({ request }) => {
  try {
    ...
    console.log("productId đây : ", productId);
    console.log("formData đây : ", formData);
      ...
      `#graphql
        ...
        appInstallation {
          metafields(
            first: 10,
            keys: [
              "product_reviews.reviews_${parseInt(productId)}",
              "product_reviews.rating_${parseInt(productId)}", 
              "product_reviews.count_${parseInt(productId)}"
            ]
          ) {
            edges {
              node {
    ...
    console.log("metafieldNodes đây : ", metafieldNodes);
